      ...
      mach: [
        {
          id: 1,
          name: "磁力研磨机",
          src: require("@/assets/imgae/磁力研磨机.png"),
        },
        {
          id: 2,
          name: "流动光饰机",
          src: require("@/assets/imgae/流动光饰机.png"),
        },
        {
          id: 1,
          name: "震动研磨机",
          src: require("@/assets/imgae/震动研磨机.png"),
        },
        {
          id: 1,
          name: "行星滚抛机",
          src: require("@/assets/imgae/行星滚抛机.png"),
        },
        {
          id: 1,
          name: "滚筒光饰机",
          src: require("@/assets/imgae/滚筒光饰机.png"),
        },
        {
          id: 1,
          name: "研磨块研磨液",
          src: require("@/assets/imgae/研磨块研磨液.png"),
        },
      ],
    };
  },
